...
\begin{frame}{Key Takeaways \& Outlook}
    ...
    \only<1>{
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.3\textwidth]{Images/AoC22_14_00_grid.png}
        \end{figure}
    }
    \only<2>{
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.3\textwidth]{Images/AoC22_14_solution_part_1.png}
        \end{figure}
    }
    \only<3>{
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\textwidth]{Images/AoC22_14_high_level.png}
        \end{figure}
    }
    \only<4>{
        \begin{figure}[H]
            \centering
            \includesvg[width=0.3\textwidth]{Images/AoC22_14_26.svg}
        \end{figure}
    }
\end{frame}
